     ...
     <a class="navbar-brand me-5 mb-lg-0" href="/html/index.html"> <img src="../assets/Images/Logo.png" width="120px" > </a>
        ...
        <div class="collapse navbar-collapse"id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-5 mb-lg-0">
            <li class="nav-item"> <a class="nav-link" href="/html/home.html"> <img src="../assets/Images/Inicio.png" height="40px" > </a> </li>
  ...
  footerMenu.innerHTML = `<div class="container-fluid text-white bg-dark py-4">
    <div class="row">
        <div class="col-12 col-sm-4 col-lg-4">
            <div class="text-center ms-auto logo me-auto"><a href="../html/home.html"></a></div>              
        </div> 
    ...
    <div class="col-12 col-sm-4 col-lg-4 ms-auto">      
      <ul class="social-icons">
        <li><a href="https://www.whatsapp.com/"style="color: lawngreen"><i class="fab fa-whatsapp"></i></a> </li>            
