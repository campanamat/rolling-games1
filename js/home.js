...
let games = [
    new Game('','GRAND THEFT AUTO V','accion','Grand Theft Auto V es un videojuego de acción-aventura de mundo abierto desarrollado por el estudio Rockstar North y distribuido por Rockstar Games. Fue lanzado el 17 de septiembre de 2013 para las consolas PlayStation 3 y Xbox 360.','../assets/Images/GTAV.png',false),
    ...
    new Game('', 'PGA TOUR 2K21','sports','PGA Tour 2K21 es un videojuego deportivo desarrollado por HB Studios y publicado por 2K Sports para Stadia, Microsoft Windows, Nintendo Switch, PlayStation 4 y Xbox One.','../assets/Images/PGATOUR2021.jpg', false),
    new Game('','AGE OF EMPIRES','estrategy','Age of Empires es una serie de videojuegos que en su mayoría pertenecen al género videojuego de estrategia en tiempo real, y hay otros juegos que pertenecen a otros géneros. La mayoría de los juegos son para la plataforma PC, y otros juegos son de otras plataformas.','../assets/Images/AGEOFEMPIRES.jpg',false),
    new Game('','WARCRAFT III','estrategy','Warcraft III: Reign of Chaos es un videojuego de estrategia en tiempo real creado por Blizzard Entertainment y es la tercera parte de la serie Warcraft','../assets/Images/warcrat1.jpg', false),
    ...
    new Game('','AJEDREZ CHESS','estrategy','Este pequeño programa de ajedrez, contempla las opciones básicas para disfrutar de este juego de estrategia. Su interfaz, pese a ser sencillo, es realmente de mucha calidad y muy claro para jugar.','../assets/Images/ajedrezchess.png',false)   
]
