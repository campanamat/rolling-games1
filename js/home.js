...
let games = [
    ...
    new Game(5,'PAC-MAN','arcade','Pac Man es un videojuego arcade creado por el diseñador de videojuegos Toru Iwatani de la empresa Namco, y distribuido por Midway Games al mercado estadounidense a principios de los años 1980. Desde que Pac-Man fue lanzado el 22 de mayo de 1980,​ fue un éxito.','../assets/Images/PACMAN.jpg',false),
    new Game(6,'TETRIS','arcade','Tetris es un videojuego de lógica originalmente diseñado y programado por Alekséi Pázhitnov en la Unión Soviética. Fue lanzado el 6 de junio de 1984, ​ mientras trabajaba para el Centro de Computación Dorodnitsyn de la Academia de Ciencias de la Unión Soviética en Moscú, RSFS de Rusia.','../assets/Images/TETRIS.png',false),
    new Game(7,'METAL SLUG 001','arcade','es un videojuego de la consola Neo-Geo creado por Nazca, posteriormente adquirido por SNK. Fue creado en 1996 para la plataforma MVS. Este juego es conocido por su sentido del humor, por sus entretenidos gráficos, y su posibilidad para dos jugadores simultáneos','../assets/Images/METALSLUG.jpg',true),
    new Game(8,'MARIO BROS','arcade','Mario Bros. es un videojuego de arcade desarrollado por Nintendo en el año 1983. Fue creado por Shigeru Miyamoto. Ha sido presentado como un minijuego en la serie de Super Mario Advance y otros juegos.','../assets/Images/MARIOBROS.jpg', false),
    new Game(9,'NBA 2K21','sports','NBA 2K21 es un videojuego de simulación de baloncesto de 2020 desarrollado por Visual Concepts y publicado por 2K Sports, basado en la Asociación Nacional de Baloncesto. Es la entrega número 22 de la franquicia NBA 2K y el sucesor de NBA 2K20, y el predecesor de NBA 2K22.','../assets/Images/NBA2K21.jpg', true),
    new Game(10,'FIFA 2022','sports','Es un videojuego desarrollado por EA Vancouver y EA Romania, siendo publicado por EA Sports. Está disponible para PlayStation 4, PlayStation 5, Xbox Series X/S, Xbox One, Microsoft Windows, Google Stadia y Nintendo Switch.','../assets/Images/fifa22.png', true),
    new Game(11,'PES 2013','sports','Pro Evolution Soccer 2013 es un videojuego de fútbol de la serie Pro Evolution Soccer desarrollado y publicado por Konami. El juego fue anunciado por Konami el 18 de abril de 2012,  fue lanzado el 20 de septiembre en Europa y empezó a ser puesto en venta el 25 de septiembre en América','../assets/Images/PES2013.webp',false),
    new Game(12, 'PGA TOUR 2K21','sports','PGA Tour 2K21 es un videojuego deportivo desarrollado por HB Studios y publicado por 2K Sports para Stadia, Microsoft Windows, Nintendo Switch, PlayStation 4 y Xbox One.','../assets/Images/PGATOUR2021.jpg', false),
    new Game(13,'AGE OF EMPIRES','estrategy','Age of Empires es una serie de videojuegos que en su mayoría pertenecen al género videojuego de estrategia en tiempo real, y hay otros juegos que pertenecen a otros géneros. La mayoría de los juegos son para la plataforma PC, y otros juegos son de otras plataformas.','../assets/Images/AGEOFEMPIRES.jpg',false),
    new Game(14,'WARCRAFT III','estrategy','Warcraft III: Reign of Chaos es un videojuego de estrategia en tiempo real creado por Blizzard Entertainment y es la tercera parte de la serie Warcraft','../assets/Images/warcrat1.jpg', false),
    new Game(15,'DOTA 2','estrategy','Ice Frog y Valve aúnan fuerzas para crear la segunda entrega de Defense of the Ancients. Manteniendo los más de cien héroes de la aventura original, el juego da un giro apostando por el motor Source desarrollado por Valve. El que nació como un mod para Warcraft III muta para convertirse en un juego free to play donde la estrategia en tiempo real y la fantasía serán los ingredientes esenciales. El juego se encuentra disponible tanto para PC como para Linux o Mac.','../assets/Images/dota2.jpg', true),
    new Game(16,'AJEDREZ CHESS','estrategy','Este pequeño programa de ajedrez, contempla las opciones básicas para disfrutar de este juego de estrategia. Su interfaz, pese a ser sencillo, es realmente de mucha calidad y muy claro para jugar.','../assets/Images/ajedrezchess.png',false)   
]
...
games.forEach(game =>{
  ...
  <a href="detailPage.html#${game.id}"><img src=${game.image} class="images" alt=${game.name}></a>
  `    
  let gameCategory = document.getElementById('arcade-container');
  gameCategory.appendChild(gameCard)
}
})
//sport 
games.forEach(game =>{
...
<a href="detailPage.html#${game.id}"><img src=${game.image} class="images" alt=${game.name}></a>
`    
let gameCategory = document.getElementById('sports-container');
gameCategory.appendChild(gameCard)
}
})
//Estrategy
games.forEach(game =>{
      ...
      let gameCard = document.createElement('card');
  gameCard.href= window.location.origin + '../html/detailPage.html#'+ game.id;    
  gameCard.id=game.id;
  gameCard.classList.add('card','m-2','bg-transparent');
  gameCard.style.width = '100%';    
  gameCard.innerHTML=`
  <a href="detailPage.html#${game.id}"><img src=${game.image} class="images" alt=${game.name}></a>
  `    
  let gameCategory = document.getElementById('estrategy-container');
  gameCategory.appendChild(gameCard)
}
})
