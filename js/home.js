...
let games = [
  ...
  new Game(
    ...
    "RESIDENT EVIL 4",
    "accion",
    "conocido en Japón como Biohazard 4, es un videojuego de disparos en tercera persona de estilo terror y supervivencia desarrollado por Capcom Production Studio 4 y distribuido por varias compañías de videojuegos, como Capcom, Ubisoft, Nintendo Australia, Red Ant Enterprises y THQ Asia Pacific.",
    "../assets/Images/RESIDENTEVIL4.jpg",
    true
  ),
  new Game(
    "",
    ...
    "../assets/Images/ASSASINGCREED.webp",
    false
  ),
  new Game(
    "",
  ...
  new Game(
    ...
    "TETRIS",
    "arcade",
    "Tetris es un videojuego de lógica originalmente diseñado y programado por Alekséi Pázhitnov en la Unión Soviética. Fue lanzado el 6 de junio de 1984, ​ mientras trabajaba para el Centro de Computación Dorodnitsyn de la Academia de Ciencias de la Unión Soviética en Moscú, RSFS de Rusia.",
  ...
  new Game(
    ...
    "METAL SLUG 001",
    "arcade",
    "es un videojuego de la consola Neo-Geo creado por Nazca, posteriormente adquirido por SNK. Fue creado en 1996 para la plataforma MVS. Este juego es conocido por su sentido del humor, por sus entretenidos gráficos, y su posibilidad para dos jugadores simultáneos",
    "../assets/Images/METALSLUG.jpg",
    true
  ),
  new Game(
    "",
  ...
  new Game(
    ...
    "NBA 2K21",
    "sports",
    "NBA 2K21 es un videojuego de simulación de baloncesto de 2020 desarrollado por Visual Concepts y publicado por 2K Sports, basado en la Asociación Nacional de Baloncesto. Es la entrega número 22 de la franquicia NBA 2K y el sucesor de NBA 2K20, y el predecesor de NBA 2K22.",
    "../assets/Images/NBA2K21.jpg",
    true
  ),
  new Game(
    "",
    "FIFA 2022",
    "sports",
    "Es un videojuego desarrollado por EA Vancouver y EA Romania, siendo publicado por EA Sports. Está disponible para PlayStation 4, PlayStation 5, Xbox Series X/S, Xbox One, Microsoft Windows, Google Stadia y Nintendo Switch.",
  ...
  new Game(
    ...
    "PES 2013",
    "sports",
    "Pro Evolution Soccer 2013 es un videojuego de fútbol de la serie Pro Evolution Soccer desarrollado y publicado por Konami. El juego fue anunciado por Konami el 18 de abril de 2012,  fue lanzado el 20 de septiembre en Europa y empezó a ser puesto en venta el 25 de septiembre en América",
    "../assets/Images/PES2013.webp",
    false
  ),
  new Game(
    "",
    "PGA TOUR 2K21",
    "sports",
    "PGA Tour 2K21 es un videojuego deportivo desarrollado por HB Studios y publicado por 2K Sports para Stadia, Microsoft Windows, Nintendo Switch, PlayStation 4 y Xbox One.",
    "../assets/Images/PGATOUR2021.jpg",
    false
  ),
  new Game(
    "",
    "AGE OF EMPIRES",
    "estrategy",
    "Age of Empires es una serie de videojuegos que en su mayoría pertenecen al género videojuego de estrategia en tiempo real, y hay otros juegos que pertenecen a otros géneros. La mayoría de los juegos son para la plataforma PC, y otros juegos son de otras plataformas.",
    "../assets/Images/AGEOFEMPIRES.jpg",
    false
  ),
  new Game(
    "",
    "WARCRAFT III",
    "estrategy",
    "Warcraft III: Reign of Chaos es un videojuego de estrategia en tiempo real creado por Blizzard Entertainment y es la tercera parte de la serie Warcraft",
    "../assets/Images/warcrat1.jpg",
    false
  ),
  new Game(
    "",
  ...
  new Game(
    ...
    "AJEDREZ CHESS",
    "estrategy",
    "Este pequeño programa de ajedrez, contempla las opciones básicas para disfrutar de este juego de estrategia. Su interfaz, pese a ser sencillo, es realmente de mucha calidad y muy claro para jugar.",
    "../assets/Images/ajedrezchess.png",
    false
  ),
];
